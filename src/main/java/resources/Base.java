...
public class Base {
    ...
    //Changed it to return string if you want later on to save it into a report in the future
    public String getScreenShot (String testName, WebDriver driver) throws IOException {
        TakesScreenshot ts = (TakesScreenshot) driver;
        File source = ts.getScreenshotAs(OutputType.FILE);
        String destFileString = System.getProperty("user.dir") + "\\reports\\" + testName + ".PNG";
        FileUtils.copyFile(source, new File(destFileString));
